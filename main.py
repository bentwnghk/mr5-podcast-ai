...
def get_mp3(text: str, voice: str, api_key: str = None, language_selection: str = "English") -> bytes:
    ...
    if language_selection == "Cantonese":
        payload["model"] = "speech-2.6-turbo"
        ...
        logger.warning(f"Unhandled language_selection '{language_selection}', defaulting to speech-2.6-turbo and including language parameter.")
        payload["model"] = "speech-2.6-turbo"
